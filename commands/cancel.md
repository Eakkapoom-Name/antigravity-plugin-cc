...
- Note in the confirmation: cancelling the Claude-side task does not delete the agy conversation; any `conversation_id` already returned stays resumable via `/agy:delegate --resume`.
